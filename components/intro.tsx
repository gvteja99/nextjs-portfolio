...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Venkat.</span> A 
        <span className="font-bold"> full-stack developer </span>
        passionate about <span className="font-bold">web tech🌐</span>,  
        <span className="font-bold">AI🧠</span>, &amp; <span className="font-bold">scalabilty🚀</span>. 
        <span> Ready to </span><span className="underline">innovate &amp; scale</span>!
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/gvteja/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/gvteja99/"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
